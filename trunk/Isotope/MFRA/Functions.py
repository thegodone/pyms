...
from pyms.Utils.Utils import is_int, is_positive_int, is_list_of_dec_nums
...
def c_mass_isotope_distr(mdv, c_corr):
    ...
    # check the arguments
    # if not is_numpy_ndarray(mdv):
        # error("'mdv' must be numpy.ndarray type")
    # if not is_numpy_ndarray(c_corr):
        # error("'c_corr' must be numpy.ndarray type")
