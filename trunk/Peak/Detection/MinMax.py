...
def minmax(ic, noise, window, peak_factor=_DEFAULT_PEAK_FACTOR ):
...
def _adjust_boundary(ia, peak_crnt, peak_next):
    ...
    crnt_apex = peak_crnt[PEAK_APEX]
    next_apex = peak_next[PEAK_APEX]
...
def _adjust_boundaries(ia, peak_list, angle_width=_DEFAULT_ANGLE_PTS, \
    ...
    for peak_item in peak_list:
        ...
        apex_index = peak_item[PEAK_APEX]
